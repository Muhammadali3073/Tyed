    ...
    pw.MultiPage(
      ...
      build: (pw.Context context) {
        return [pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
          ...
          pw.Text(
            tyedQuestionsController.tyedAnswersModel.tyedDateAnswer.toString(),
            style: pw.TextStyle(
              fontSize: 14,
            ),
          ),pw.SizedBox(
          ...
          pw.Text(
            tyedQuestionsController.tyedAnswersModel.assetsBelongOnlyYouQuestion
                .toString(),
            style: pw.TextStyle(
              fontSize: 14,
              fontWeight: pw.FontWeight.bold,
          ...
          pw.Text(
            tyedQuestionsController.tyedAnswersModel.havePetQuestion.toString(),
            style: pw.TextStyle(
              fontSize: 14,
              fontWeight: pw.FontWeight.bold,
            ),
          ...
          pw.Text(
            tyedQuestionsController.tyedAnswersModel.tyedEndsAnswer.toString(),
            style: pw.TextStyle(
              fontSize: 14,
            ),
          ),pw.SizedBox(
          ...
          pw.Text(
            tyedQuestionsController.tyedAnswersModel.spousalSupportEndsQuestion
                .toString(),
            style: pw.TextStyle(
              fontSize: 14,
              fontWeight: pw.FontWeight.bold,
          ...
          pw.Text(
            tyedQuestionsController.tyedAnswersModel.youPassedAnswer.toString(),
            style: pw.TextStyle(
              fontSize: 14,
            ),
          ),pw.SizedBox(
          ...
          pw.Text(
            tyedQuestionsController.tyedAnswersModel.anythingElseIncludeQuestion
                .toString(),
            style: pw.TextStyle(
              fontSize: 14,
              fontWeight: pw.FontWeight.bold,
          ...
          pw.Text(
            tyedQuestionsController.tyedAnswersModel.likeToAddAnswer.toString(),
            style: pw.TextStyle(
              fontSize: 14,
            ),
          ),
